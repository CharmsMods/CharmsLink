...
// DOM Elements (already defined in asset-list-page.js)
...
if (typeof window.showLoadingOverlay === 'undefined') {
    window.showLoadingOverlay = () => {
        if (window.loadingOverlayTimeoutId) {
            clearTimeout(window.loadingOverlayTimeoutId);
            window.loadingOverlayTimeoutId = null;
        }
...
if (typeof window.hideLoadingOverlayWithDelay === 'undefined') {
    window.hideLoadingOverlayWithDelay = (delay, finalMessage) => {
        ...
        window.loadingOverlayTimeoutId = setTimeout(() => {
            const overlay = document.getElementById('loading-overlay');
            if (overlay) {
