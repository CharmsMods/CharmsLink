...
function classifyProbe(rawIfd, rootIfd) {
    ...
    if ((tags.OpcodeList1 || tags.OpcodeList2 || tags.OpcodeList3) && unsupportedOpcodeIds.length) {
        fidelity = fidelity === 'unsupported' ? fidelity : 'partial';
    ...
    return {
        ...
        hasGainMap: !!tags.ProfileGainTableMap || decoded.gainMaps.length > 0,
        ...
        supportsOpcodeCorrections: !!(tags.OpcodeList1 || tags.OpcodeList2 || tags.OpcodeList3) && unsupportedOpcodeIds.length === 0,
        supportsGainMapCorrections: decoded.gainMaps.length > 0,
        fidelity,
        warnings
    };
}
